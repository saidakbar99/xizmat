                    ...
                    <div className="flex flex-col">
                        <div className="flex flex-col lg:flex-row">
                            <div className="lg:mr-12 mx-auto">
                                ...
                                <img className="w-[155px] h-[155px] mx-auto mt-8 hidden lg:block" src={qrAppstore} alt="qr1" />
                            </div>
                            <div className="mx-auto">
                                ...
                                <img className="w-[155px] h-[155px] mx-auto mt-8 hidden lg:block" src={qrPlaymarket} alt="qr2" />
                            </div>
                        </div>
